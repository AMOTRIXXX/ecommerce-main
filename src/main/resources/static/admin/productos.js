...
document.addEventListener("DOMContentLoaded", () => {
    // Mostrar un thumbnail cuando se sube/edita la imagen de un producto
    const inputs = document.querySelectorAll("input[data-img-thumb]");
    inputs.forEach(thumb => thumb.addEventListener("change", function() {
        const id = this.getAttribute("data-img-thumb");
