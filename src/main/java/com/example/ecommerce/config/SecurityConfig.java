...
public class SecurityConfig
{
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception
    {
        ...
        return http
            ...
            {
                auth.requestMatchers(publicResources).permitAll(); // Rutas disponibles para cualquier usuario/visitante
                auth.requestMatchers("/admin/**").hasAuthority("ADMIN"); // Rutas protegidas - solo pueden acceder quienes tengan el rol "ADMIN"
